  ...
  try {
    ...
    try {
      ...
      if (user) {
        ...
        // Send order confirmation SMS — use user phone or shipping phone as fallback
        ...
        if (smsPhone) {
          try {
            ...
            console.error('Order confirmation SMS failed:', smsErr.message);
          }
        } else {
          console.warn(`⚠️ No phone on file for user ${user._id} — order SMS skipped`);
        }
